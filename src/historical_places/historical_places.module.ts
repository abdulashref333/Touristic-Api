...
import { HistoricalPlacesEntity, HistoricalPlacesSchema } from './entities/historical_places.entity';
...
@Module({
  imports:[MongooseModule.forFeature([{name:"HistoricalPlaces",schema:HistoricalPlacesSchema}]),
